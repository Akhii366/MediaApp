    ...
    <>
      <Row>
        ...
        <Col lg={5}>
          ...
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste id, exercitationem quis, recusandae sunt debitis tempora alias impedit quos molestias dolor accusantium, inventore quod consectetur obcaecati veniam aliquam! Qui, mollitia!
            Pariatur officiis quo maxime sequi laborum voluptates aspernatur praesentium soluta explicabo numquam, minus architecto obcaecati quae quis eaque recusandae ullam facilis, laudantium quas? Facere nemo commodi autem, sapiente repellat delectus.</p>
      ...
      <div className='container border rounded p-5 border-light mb-5 d-flex align-items-center justify-content-between w-100'>
        <div className='c0l-lg-5'>
          <h4 className='text-warning'>Simple,Powerful & Fast</h4>
          <h6 className='mb-5 mt-3'><span className='text-warning fw-bolder'>Play Everything</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima reiciendis unde libero optio qui adipisci iusto, voluptate harum reprehenderit neque porro asperiores sequi itaque consectetur accusantium a, placeat, beatae animi?
            Nostrum dignissimos ab magni nulla deserunt? Ducimus, culpa molestias. Numquam quidem minima dolorem a aliquid porro, asperiores exercitationem ab odit quis dolorum dolor eaque, sapiente assumenda illum eveniet est aperiam.</h6>
